...
function toRegExpAST(regex: ExtRegex): AST.RegExpAST {
  switch (regex.type) {
    case 'epsilon':
      return regex
    case 'literal':
...
function fromRegExpAST_(ast: AST.RegExpAST): ExtRegex {
  switch (ast.type) {
    ...
    case 'complement':
      return complement(fromRegExpAST_(ast.inner))
    case 'intersection':
      return intersection(fromRegExpAST_(ast.left), fromRegExpAST_(ast.right))
    case 'start-marker': {
    ...
    case 'positive-lookahead':
      throw new Error('Positive lookahead not supported in regex operations')
    case 'negative-lookahead':
      throw new Error('Negative lookahead not supported in regex operations')
    case 'positive-lookbehind':
      throw new Error('Positive lookbehind not supported in regex operations')
    case 'negative-lookbehind':
      throw new Error('Negative lookbehind not supported in regex operations')
  }
  checkedAllCases(ast)
}
